...
const config = {
  ...
  digiseller: {
    ...
    failPageUrl: process.env.DIGISELLER_FAIL_PAGE_URL || 'https://xboxtracker.ru/',
    ...
    keyActivationFailPageUrl: process.env.DIGISELLER_KEY_ACTIVATION_FAIL_PAGE_URL || 'https://xboxtracker.ru/',
